...
// tsc/index.js
(async () => {
  const wasmBinary = await fs.readFile(path.join(import.meta.dirname, "../", "node_modules/@babylonjs/havok/lib/esm/HavokPhysics.wasm"));
  const havokInterface = await HavokPhysics_es_default({ wasmBinary });
